...
const Admin = () => {
  ...
  const fetchUsers = async () => {
    try {
      const res = await axios.get("https://sheshield-api.onrender.com.onrender.com/api/admin/users");
  ...
  const fetchSOS = async () => {
    try {
      const res = await axios.get("https://sheshield-api.onrender.com.onrender.com/api/admin/sos");
